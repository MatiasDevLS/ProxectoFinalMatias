...
class UsuarioController extends Controller
{
    ...
    {
        if (empty($request['imagenUrl'])) { // Imagen default si el usuario no establece ninguna
    ...
    // Recoge los datos del inicio de sesión, los valida y si son correctos crea la sesión y las cookies
    ...
    // Obtiene los datos del usuario a partir de la sesión
